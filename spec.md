...
encoding is as a Big Endian integer padded (at the front) with zeroes to
satisfy the fixed encoded byte size. Its human-readable encoding is as a
base-16 number encoded as String.
