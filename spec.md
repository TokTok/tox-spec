...
configured by the bucket size. When adding a node to a full bucket, the Node
Info with the greatest distance from the base key is removed to keep the bucket
size below the maximum size.
